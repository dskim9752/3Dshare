...
public class ConnectionProvider {
	...
	private static final String PROPERTIES = "?useSSL=false&serverTimezone=UTC"; // MySQL Connector J 8.0
	...
	private static final String DB_URL = "jdbc:mysql://localhost:3306/" + DB_SCHEMAS + PROPERTIES +"&allowPublicKeyRetrieval=true&useSSL=false"; 
